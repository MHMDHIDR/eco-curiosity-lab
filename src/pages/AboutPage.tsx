      ...
      <div className='container mx-auto px-4 py-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
            Discover the incredible diversity of life on our planet through an
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-foreground leading-relaxed'>
                  {APP_NAME} aims to make biodiversity education accessible, engaging, and
                  inspiring for learners of all ages. We believe that understanding and
                  appreciating the natural world is crucial for its conservation and our
                  collective future.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className='space-y-2 text-foreground'>
                  ...
                  <li>
                    • Provides essential resources for medicine, food, and materials
                  </li>
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Journey through Earth's diverse habitats from rainforests to ocean
                      depths.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Learn about fascinating species with detailed information and fun
                      facts.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Understand the conservation status and threats facing different
                      species.
                    </p>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className='text-foreground mb-4'>
                  Our content is based on scientific research and data from reputable
                  sources:
                </p>
          ...
          <Card className='max-w-2xl mx-auto'>
            <CardContent className='pt-6'>
              ...
              <p className='text-muted-foreground mb-6'>
                Dive into the amazing world of biodiversity and start your journey of
                discovery today.
              </p>
